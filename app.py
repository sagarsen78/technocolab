# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 14:33:40 2021

@author: MohammedMuqtader Ali
"""
...
def home():
    ...
    return render_template("app.html", education_status = education_status, marital_status = marital_status, payment_status = payment_status, alert_message = alert_message, success_message = success_message)
